...
cgpa             = c2.number_input("CGPA",              min_value=2.0, max_value=4.0, value=3.1, step=0.01, format="%.2f")
attendance       = c3.number_input("Attendance (%)",    min_value=50, max_value=100, value=82, step=1)
study_hours      = c4.number_input("Study Hours / Week", min_value=5, max_value=45, value=21, step=1)
